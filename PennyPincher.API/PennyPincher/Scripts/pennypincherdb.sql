...
INSERT INTO public.cashflow_group (group_name, description, user_id) VALUES
    ...
    ('Health',       'Gym memberships and classes',           4),
...
INSERT INTO public.cashflow_entry (
    ...
    ('Rent',             'Monthly apartment rent',          1200, '2025-07-01', 'Expense', 'Living',        1),
    ...
    ('Yoga Class',       'Drop-in yoga session',              20, '2025-07-09', 'Expense', 'Health',        4),
    ('Therapy Session',  'Mental health counseling',          90, '2025-07-12', 'Expense', 'Insurance',     4),
    ...
    ('Pet Food',         'Bulk dog food purchase',            60, '2025-07-07', 'Expense', 'Living',        5),
    ('Vet Appointment',  'Dog annual checkup',                80, '2025-07-17', 'Expense', 'Insurance',     5),
